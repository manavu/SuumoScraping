...
namespace SuumoScraping.Migrations
{
    public partial class InitMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Access1 = table.Column<string>(
                        type: "varchar(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    Access2 = table.Column<string>(
                        type: "varchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    Access3 = table.Column<string>(
                        type: "varchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    ...
                    FloorAreaMeasuringMethod = table.Column<string>(
                        type: "longtext",
                        nullable: true
                    ),
                    Balcony = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
                    BuiltYears = table.Column<DateTime>(type: "datetime", nullable: true),
                    ManagementFee = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    RepairingDeposit = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    RepairingFund = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    UseDistrict = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    Structure = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    RightsStyle = table.Column<string>(
                        type: "varchar(300)",
                        maxLength: 300,
                        nullable: true
                    ),
                    MoveInTime = table.Column<string>(
                        type: "varchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    Company_Address = table.Column<string>(
                        type: "varchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    Company_TakkenLicense = table.Column<string>(
                        type: "varchar(80)",
                        maxLength: 80,
                        nullable: true
                    ),
                    Company_TransactionAspect = table.Column<string>(
                        type: "varchar(80)",
                        maxLength: 80,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuiltYears = table.Column<string>(
                        type: "varchar(20)",
                        maxLength: 20,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateIndex(name: "IX_Files_Url", table: "files", column: "Url");
        ...
        {
            migrationBuilder.DropTable(name: "bukkenfiles");

            migrationBuilder.DropTable(name: "newbukkenfiles");

            migrationBuilder.DropTable(name: "prices");

            migrationBuilder.DropTable(name: "bukkens");

            migrationBuilder.DropTable(name: "files");

            migrationBuilder.DropTable(name: "newbukkens");

            migrationBuilder.DropTable(name: "bukkenfulltexts");
        }
    }
}
